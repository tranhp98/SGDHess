...
def get_params_grad(model):
    ...
    for n, param in model.named_parameters():
        ...
        if not param.requires_grad:# or "decoder.sentence_encoder.embed" in n:
            continue
        params.append(param)
        gradsH.append(0. if param.grad is None else param.grad + 0.)
        names.append(n)
    return params, gradsH, names
...
class FairseqTask(object):
    ...
    def train_step(
        ...
        #print("fairseq_task at iteration", self.iteration)
        self.iteration += 1
        ...
        with torch.autograd.profiler.record_function("backward"):
            ...
            param_, gradsH, names = get_params_grad(model)
    ...
    def optimizer_step(self, optimizer, model, update_num, gradsH):
        optimizer.step(gradsH = gradsH)
